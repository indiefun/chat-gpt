...
export const DIFFUSION_OPTIONS_DEFAULTS = {
  negative_prompt: "",
  seed: -1,
  steps: 50,
  cfg_scale: 7.5,
...
export const DIFFUSION_OPTIONS_RANGES = {
  steps: { min: 1, max: 150, step: 1 },
  cfg_scale: { min: 1, max: 30, step: 0.5 },
  width: { min: 256, max: 1024, step: 256 },
  height: { min: 256, max: 1024, step: 256 },
